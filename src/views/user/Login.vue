...
<b-row class="h-100 loginForm">
    <b-colxx xxs="12" md="10" class="mx-auto my-auto">
        <b-card class="auth-card" no-body>
            ...
            <div class="form-side logoContext">
                <router-link to="/">

                    <!--
                    <span class="logo-single" /> -->

                    <img class="newLogo" src="/assets/logos/logo.png" />

                </router-link>
                <h6 class="mb-4 text-align-left">{{ $t('user.login-title')}}</h6>
